  ...
  return (
    <section id="intro-container">
      <section className="intro-page">
          ...
          <motion.img drag whileDrag={{scale:0.8, borderRadius:60, zIndex:99, background:0, boxShadow:0}} dragSnapToOrigin whileHover={{scale:1.2, zIndex:99, background:0, boxShadow:0}} src={imgme} alt="Me" className='photo'/>
          </div>
      </section>
    </section>
  )
